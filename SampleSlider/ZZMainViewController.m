...
@synthesize recipeeArray,recipee;
...
- (void)viewDidLoad {
  ...
  _payPalConfig.acceptCreditCards = YES;
    ...
    [self setPayPalEnvironment:@"sandbox"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSString *packName1 = [packName objectAtIndex:indexPath.row];
    NSString *price1 = [price objectAtIndex:indexPath.row];
    NSString *credits1 = [credits objectAtIndex:indexPath.row];
...
{
    Packs *selectedCell = [tableView cellForRowAtIndexPath:indexPath];
